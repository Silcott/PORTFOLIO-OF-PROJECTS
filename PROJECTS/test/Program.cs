...
namespace test
{
    ...
    public static class Program
    {
        ...
        static void SelectionCategories()
        {
            var consoleWidth = Console.WindowWidth;
            var dividedWidth = consoleWidth / 2;
            string spaces = ' '.Repeat(dividedWidth);
